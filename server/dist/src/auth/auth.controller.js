...
const current_user_decorator_1 = require("../common/decorators/current-user/current-user.decorator");
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({
        ...
        type: auth_dto_1.MessageResponseDto,
    }),
    __param(0, (0, common_1.Body)(common_1.ValidationPipe)),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Validate current session' }),
